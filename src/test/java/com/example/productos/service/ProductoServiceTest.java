...
class ProductoServiceTest {
    ...
    /**
	 * @Usuario Sergio
	 * @Descripcion Edita los datos de un producto
	 */
    @Test
    @Order(2)	
    void editarYObtenerProducto() {
        Producto creado = service.editar("Monitor Curvo", new BigDecimal("895.13"), 45);
        Producto obtenido = service.obtenerPorId(creado.getId());
        assertThat(obtenido.getNombre()).isEqualTo("Monitor Curvo");
    }
    ...
    void listaProductoByNombre() {
    	assertThatThrownBy(() -> service.obtenerPorNombre("Monitor Curvo"))
        .isInstanceOf(NotFoundException.class);
    }
